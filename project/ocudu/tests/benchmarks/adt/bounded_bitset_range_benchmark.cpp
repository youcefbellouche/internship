...
template <unsigned N>
static void benchmark_bounded_bitset_any(const ocudu::bounded_bitset<N>& bitset, std::string description)
{
...
template <unsigned N>
static void benchmark_bounded_bitset_anytest(const ocudu::bounded_bitset<N>& bitset, std::string description)
{
  bm->new_measure(description, params.nof_repetitions, [&bitset]() {
    bool value = false;
...
template <unsigned N>
static void benchmark_bounded_bitset_all(const ocudu::bounded_bitset<N>& bitset, std::string description)
{
  bm->new_measure(description, params.nof_repetitions, [&bitset]() {
...
template <unsigned N>
static void benchmark_bounded_bitset_alltest(const ocudu::bounded_bitset<N>& bitset, std::string description)
{
  bm->new_measure(description, params.nof_repetitions, [&bitset]() {
    bool value = true;
    for (unsigned i = params.start_offset; i != params.last_offset; ++i) {
...
template <unsigned N>
static void benchmark_bounded_bitset_fill(ocudu::bounded_bitset<N>& bitset, std::string description)
{
  bm->new_measure(description, params.nof_repetitions, [&bitset]() {
...
template <unsigned N>
static void benchmark_bounded_bitset_fillset(ocudu::bounded_bitset<N>& bitset, std::string description)
{
  bm->new_measure(description, params.nof_repetitions, [&bitset]() {
    for (unsigned i = params.start_offset; i != params.last_offset; ++i) {
      bitset.set(i);
...
template <unsigned N>
static void benchmark_bounded_bitset_slice(ocudu::bounded_bitset<N>& bitset, std::string description)
{
...
template <unsigned N>
static void benchmark_bounded_bitset_slicetestset(ocudu::bounded_bitset<N>& bitset, std::string description)
{
  unsigned slice_start = params.start_offset;
  unsigned slice_end   = slice_start + (params.last_offset - params.start_offset) / 2;
  bm->new_measure(description, params.nof_repetitions, [&bitset, slice_start, slice_end]() {
