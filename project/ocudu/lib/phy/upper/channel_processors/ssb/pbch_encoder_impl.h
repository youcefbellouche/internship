...
class pbch_encoder_impl : public pbch_encoder
{
  ...
  /// \brief Implements TS38.212 Section 7.1.1 PBCH payload generation.
  ...
  /// \brief Implements TS38.212 Section 7.1.2 Scrambling.
  ...
  /// \brief Implements TS38.212 Section 7.1.3 Transport block CRC attachment.
